...
1. **Conceptos**  
2. **Bienestar**: conceptualizaciones directas e indirectas  
3. **Pobreza**  
    - Pobreza absoluta  
    - Pobreza relativa  
4. **Privación**  
...
- **Beduek, S. (2018)**. Understanding material deprivation for 25 EU countries. *European Sociological Review*, 34(2), 121-137.  
- **Bourguignon, F. (2004)**. The poverty-growth-inequality triangle (*Working Paper* No. 125).  
- **Larrañaga, O. & Rodríguez, M. E. (2014)**. Desigualdad de Ingresos y Pobreza en Chile 1990 (*Documento de Trabajo*).
